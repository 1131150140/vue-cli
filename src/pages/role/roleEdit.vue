          ...
          <el-col :span="10">
           <div @click="dianji" class="dianji">
              ...
              <el-form-item label="归属公司" prop="fatherDepartId">
                <el-input size="small" readonly v-model="ruleForm.departName"></el-input>
              </el-form-item>
           </div>
  ...
  <el-form-item>
    ...
    <el-dialog title="归属公司"  :visible.sync="dialogFormVisible1">
       ...
       <div slot="footer" class="dialog-footer">
         ...
         <el-button type="primary" @click="chaxunyingyingshang" size="small">查询</el-button>
       </div>
     </el-dialog>
...
<script>
import {getrolexiangqing, getcompanystructure, userroleUpdate} from '@/api/index'
export default {
   data() {
     return {
        ruleForm: {},
     ...
     methods: {
        ...
        dianjixiang(str1, str2, str3) {
          ...
          this.ruleForm.departName = str1.name;
        },
      ...
      submitForm() {
        ...
        userroleUpdate(this.ruleForm).then(res => {
          if (res.code == 200) {
               this.open3('成功修改角色信息!');
          } else {
      ...
      chaxunyingyingshang() {
       ...
       getxinxi() {
         ...
         getrolexiangqing(roleId).then(res => {
