        ...
        <el-row>
           <el-col :span="10">
            <el-form-item class="bitian" label="月数" prop="name">
                <el-input size="small"  v-model="ruleForm.monthNumber"></el-input>
              </el-form-item>
         </el-col>
       </el-row>
        <el-row>
...
<script>
import {  financialSchemeEdit, financialSchemeList, getbankList} from '@/api/index'
export default {
   data() {
     return {
        ruleForm: {
     ...
     methods: {
      ...
      submitForm() {
        ...
        financialSchemeEdit(this.ruleForm).then(res => {
          if (res.code == 200) {
              this.open3('保存修改成功!')
      ...
      getyinhangList() {
       ...
       getxinxi() {
          ...
          financialSchemeList({'id': id}).then(res => {
