<template>
   <div class="Kaikaluru">
        ...
        <el-form-item label="姓名" >
            <el-input  v-model="kaika.name"  readonly size="small" ></el-input>
        </el-form-item>
       ...
       <el-form-item size="small" label="性别" >
            <el-select v-model="kaika.gender" class="gender" placeholder="请选择">
            <el-option label="男" value="男"></el-option>
            <el-option label="女" value="女"></el-option>
            </el-select>
        </el-form-item>
         <el-form-item label="姓名拼音" >
            <el-input    v-model="kaika.englishName" size="small" ></el-input>
        </el-form-item>
         <el-form-item label="名族" >
            <el-input   v-model="kaika.nation"  size="small"></el-input>
        </el-form-item>
         <el-form-item size="small" label="证件类型" >
            <el-select value="居民身份证" class="gender" placeholder="请选择">
        ...
        <el-form-item label="出生地" >
            <el-input   v-model="kaika.birthplace"  size="small"></el-input>
        </el-form-item>
        <el-form-item label="国籍" >
            <el-input  readonly v-model="kaika.nationality"  size="small"></el-input>
        </el-form-item>
         <el-form-item  size="small" label="婚姻状况" >
            <el-select v-model="kaika.isMarried"  class="gender" placeholder="请选择">
         ...
         <el-form-item  size="small" label="教育程度" >
            <el-select v-model="kaika.highestDegree"  class="gender" placeholder="请选择">
         ...
         <el-form-item label="曾就读小学" >
            <el-input v-model="kaika.primarySchoolAttended"   size="small" ></el-input>
        </el-form-item>
        <el-form-item label="手机" >
            <el-input   size="small" v-model="kaika.phoneNumber" ></el-input>
        </el-form-item>
        <el-form-item label="住宅地址" >
            <el-input   size="small" v-model="kaika.currentAddress" ></el-input>
        </el-form-item>
        <el-form-item label="家庭邮编" >
            <el-input   size="small" v-model="kaika.homePostcode" ></el-input>
        </el-form-item>
        
        <el-form-item size="small" label="住宅状况" >
            <el-select  class="gender" v-model="kaika.kindOfProperty" placeholder="请选择">
         ...
         <el-form-item label="通讯地址" >
            <el-input  v-model="kaika.mailingAddress"  size="small" ></el-input>
        </el-form-item>
         <el-form-item label="通讯地邮编" >
            <el-input  v-model="kaika.mailingAddressPostcode"  size="small" ></el-input>
        </el-form-item>
         <el-form-item label="几家银行" >
            <el-input   size="small" v-model="kaika.cardInfoHave" placeholder="持有几家银行的信用卡" ></el-input>
        </el-form-item>
         <el-form-item label="信用卡数量" >
            <el-input   size="small" v-model="kaika.cardInfoZhang" placeholder="信用卡持有的张数" ></el-input>
        </el-form-item>
        <el-form-item label="额度总额" >
            <el-input   size="small" v-model="kaika.cardInfoWan" placeholder="信用卡额度总额以万为单位" ></el-input>
        </el-form-item>
        <br />
        <el-form-item label="单位名称" >
            <el-input   size="small" v-model="kaika.companyName"  ></el-input>
        </el-form-item>
         <el-form-item label="单位地址" >
            <el-input   size="small" v-model="kaika.companyAddress"  ></el-input>
        </el-form-item>
         <el-form-item label="单位邮编" >
            <el-input   size="small" v-model="kaika.companyPostcode" ></el-input>
        </el-form-item>
         <el-form-item label="单位电话" >
            <el-input   size="small" v-model="kaika.companyPhoneNumber" ></el-input>
        </el-form-item>
        <el-form-item size="small" label="经营性质" >
            <el-select v-model="kaika.workNature"  class="gender" placeholder="单位经营性质">
         ...
         <el-form-item size="small" label="所属行业" >
            <el-select v-model="kaika.industryInvolved" class="gender" placeholder="请选择">
         ...
         <el-form-item size="small" label="职业" >
            <el-select v-model="kaika.industryProfession"  class="gender" placeholder="请选择">
         ...
         <el-form-item size="small" label="职务" >
            <el-select  v-model="kaika.position" class="gender" placeholder="请选择">
        ...
        <el-form-item label="年收入" >
            <el-input v-model="kaika.annualIncome"   size="small"  placeholder="以万为单位"></el-input>
        </el-form-item>
        <br>
        <el-form-item label="亲属联系人" >
            <el-input   size="small" v-model="lianxiren[0].name"  placeholder="亲属联系人姓名"></el-input>
        </el-form-item>
        <el-form-item size="small" label="性别" >
            <el-select class="gender" v-model="lianxiren[0].gender" placeholder="请选择">
            <el-option label="男" value="男"></el-option>
            <el-option label="女" value="女"></el-option>
            </el-select>
        </el-form-item>
        <el-form-item size="small" label="关系" >
            <el-select class="gender" v-model="lianxiren[0].relationship" placeholder="请选择">
         ...
         <el-form-item label="手机号码">
            <el-input   size="small" v-model="lianxiren[0].phone" ></el-input>
        </el-form-item>
        <br />
          <el-form-item label="紧急联系人" >
            <el-input   size="small" v-model="lianxiren[1].name"  placeholder="紧急联系人姓名"></el-input>
        </el-form-item>
        <el-form-item size="small" label="性别" >
        ...
        <el-form-item size="small" label="关系" >
           <el-select class="gender" placeholder="请选择" v-model="lianxiren[1].relationship">
            <el-option label="夫妻" value="夫妻"></el-option>
            <el-option label="父子" value="父子"></el-option>
            <el-option label="母子" value="母子"></el-option>
             <el-option label="兄弟姐妹" value="兄弟姐妹"></el-option>
         ...
         <el-form-item label="手机号码">
            <el-input   size="small" v-model="lianxiren[1].phone" ></el-input>
        </el-form-item>
        <br />
         <el-form-item label="贷款金额">
            <el-input   size="small" v-model="kaika.actualLoanAmount" placeholder="单位以万为单位" ></el-input>
        </el-form-item>
         <el-form-item label="申请额度">
            <el-input   size="small" v-model="kaika.applyLimit" placeholder="单位以元为单位" ></el-input>
        </el-form-item>
         <el-form-item size="small" label="寄送方式" >
            <el-select class="gender" v-model="kaika.billDealingAddress" placeholder="账单寄送方式">
         ...
         <el-form-item size="small" label="寄送地址" >
            <el-select class="gender" v-model="kaika.billDealingMethod" placeholder="账单寄送地址">
         ...
         <el-form-item size="small" label="领取方式" >
            <el-select class="gender" v-model="kaika.cardReceiveMode" placeholder="卡片领取方式">
            <el-option label="自取" value="自取"></el-option>
            <el-option label="寄送" value="寄送"></el-option>
            </el-select>
        </el-form-item>
         <el-form-item size="small" label="寄送地址" >
            <el-select class="gender" v-model="kaika.cardDealingAddress" placeholder="卡片寄送地址">
            <el-option label="单位地址" value="单位地址"></el-option>
            <el-option label="住宅地址" value="住宅地址"></el-option>
            <el-option label="通讯地址" value="通讯地址"></el-option>
            </el-select>
         ...
         <el-form-item size="small" label="变动提醒" >
            <el-select class="gender" v-model="kaika.balanceRemind" placeholder="是否开通余额变动提醒">
            <el-option label="是" value="是"></el-option>
            <el-option label="否" value="否"></el-option>
            </el-select>
        </el-form-item>
         <el-form-item label="车价">
            <el-input   size="small" v-model="kaika.vehiclePrice" placeholder="单位以元为单位" ></el-input>
        </el-form-item>
    </el-form>
   <el-row class="pics">
    <el-col :span="6" class="dinggao" >
        <span>合同</span>
        <Picuoload data-CategoryName="合同"  ref="shangchuan" :data-id="dataShuzu.split(',')[0]" />
    </el-col>
    <el-col :span="6" class="dinggao" >
        <span>合同申请表</span>
        <Picuoload data-CategoryName="合同申请表"  ref="shangchuan"  :data-id="dataShuzu.split(',')[1]" />
    </el-col>
    <el-col :span="6" class="dinggao" >
        <span>开卡资料</span>
         <Picuoload data-CategoryName="开卡资料" ref="shangchuan"  :data-id="dataShuzu.split(',')[2]" />
    </el-col>
    <el-col :span="6" class="dinggao" >
        <span>合成开卡/身份证JPG</span>
        <Picuoload data-CategoryName="合成开卡/身份证JPG" ref="shangchuan"  :data-id="dataShuzu.split(',')[3]" />
    </el-col>
</el-row>
    <el-row class="xiayi">
...
<script>
 ...
 import {selectInfo, kaika} from '@/api/index'
export default {
     data() {
        return {
            formInline: {
       ...
       getSelectInfo() {
           selectInfo(this.ss).then(res => {
              if (res.code == 200) {
                  console.log(res)
                  let data = res.data;
                  this.kaika.name = data.name;
                  this.kaika.birthday = data.birthday;
                  this.kaika.gender =data.gender;
                  this.kaika.nation =data.nation;
                  this.kaika.idCard =data.idCard;
                  this.kaika.issuingOrgan = data.issuingOrgan;
                  this.kaika.idCardValidDate = data.idCardValidDate;
                  this.kaika.birthplace = data.placeOfDomicile;
                  this.kaika.phoneNumber = data.phoneNumber;
                  this.kaika.id = data.id;
