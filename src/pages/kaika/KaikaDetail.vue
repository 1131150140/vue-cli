<template>
   <div class="Kaikaluru">
    ...
    <el-row >
     ...
     <el-form :inline="true" v-if="kaika.auditStatus != '0'"  style="padding:0 50px;margin-top:20px;" :model="formInline"  class="demo-form-inline">
        <el-row :gutter="10" class="flexju">
        <el-col :span="10"><div class="grid-content bg-purple">
            <el-form-item label="审核状态">
            <el-select disabled=""  v-model="kaika.auditStatus"  placeholder="审核结果" >
            <el-option label="通过" value="1"></el-option>
            <el-option label="不通过" value="2"></el-option>
            </el-select>
            </el-form-item></div>
        </el-col>
         <el-col :span="12" v-show="kaika.auditStatus == 1"><div class="grid-content bg-purple">
            <el-form-item label="银行卡号" >
                <el-input readonly v-model="kaika.account"  size="small" ></el-input>
            </el-form-item>
            </div>
        </el-col>
        </el-row>
         <el-form-item label="审核备注" class="textleft shenhebeizhu" style="width:100%" >
          <div class="el-form-item__content beizhu" style="width:100%!important">
              <div data-v-467b687c="" class="el-textarea">
                  <textarea readonly class="el-textarea__inner qubie" v-model="kaika.auditResult" style="min-height: 33px;"></textarea>
                  </div></div>
        </el-form-item>
      </el-form>
