...
<template slot-scope="scope">
  <el-button @click="ClickShenhe(scope.$index)" v-show="tableData[scope.$index].tCardInfo.auditStatus == '0'"  type="text" >审核</el-button>
  <el-button @click="ClickDetail(scope.$index)" v-show="tableData[scope.$index].tCardInfo.auditStatus != '0'" type="text" >详情</el-button>
...
import {kaikashenhelist} from '../../api/index'
    ...
    methods: {
      ...
      ClickShenhe(id) {
        ...
        this.$router.push({path: '/kaikaiAudit'})
      },
      ClickDetail(id) {
        localStorage.setItem('applicationFormId', this.tableData[id].tApplicationForm.id);
