...
<script>
import {  getcompanystructure,addadmin, getstructure, resourceAdd, resourceGetresource, resourceModify} from '@/api/index'
export default {
   data() {
     return {
        ruleForm: {
     ...
     methods: {
      ...
      submitForm() {
        ...
        resourceModify(this.ruleForm).then(res => {
          if (res.code == 200) {
              this.open3('保存修改成功!')
      ...
      chaxunyingyingshang() {
       ...
       getxinxi() {
          ...
          resourceGetresource(id).then(res => {
